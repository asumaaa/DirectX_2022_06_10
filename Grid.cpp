...
void Grid::Initialize(XMFLOAT3 size, DirectXIni* dx_)
{
	dx = dx_;
	HRESULT result;

	vertex = Ver3::GetInstance();
...
void Grid::Update()
{
	...
	//プリミティブ形状の設定コマンド
	dx->GetCommandList()->IASetPrimitiveTopology(D3D_PRIMITIVE_TOPOLOGY_LINELIST);	//三角形リスト
